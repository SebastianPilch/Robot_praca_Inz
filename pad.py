...
def parse_arrow_dict(arrow_dict):
    if not arrow_dict == {}:
        name_dict = {"left": 1 if arrow_dict[0][0] == -1 else 0, "right": 1 if arrow_dict[0][0] == 1 else 0,
                     "up": 1 if arrow_dict[0][1] == 1 else 0, "down":1 if arrow_dict[0][1] == -1 else 0}
        return name_dict
    else:
    ...
    def listen(self):
        ...
        while True:
            ...
            for event in pygame.event.get():
                ...
                # print(self.button_data, self.axis_data, self.hat_data, (" " * 150))
                ...
                print(state[Ps4Controls.CIRCLE], '\n')
